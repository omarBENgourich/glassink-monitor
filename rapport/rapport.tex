...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \begin{projectbox}
      ...
      Élève ingénieur en Réseaux et Systèmes de Télécommunication\\
      Option Systèmes ubiquitaires\\[3mm]
      \textbf{Organisme d'accueil :} Saint-Gobain Sekurit Maroc\\[3mm]
      \textbf{Encadrement professionnel :} M. Yassine Boubkari\\[1mm]
      \textbf{Encadrement académique :} Prof. T. Boujiha
    \end{projectbox}
...
À mes parents, d'abord. Pour les sacrifices qu'on ne voit pas toujours, pour la
confiance même dans les périodes de doute, et pour cette présence tranquille qui
donne du courage quand le rythme devient lourd.

À ma famille, pour son soutien constant et pour les mots simples qui remettent
les choses à leur place.

À mes amis et à mes camarades de promotion, avec qui les nuits de travail, les
bugs incompréhensibles et les deadlines ont fini par devenir une partie de
l'histoire.

Je dédie ce travail à toutes les personnes qui m'ont aidé à avancer, parfois
avec un conseil, parfois seulement avec de la patience.

\chapter*{Remerciements}
\addcontentsline{toc}{chapter}{Remerciements}
Je tiens à remercier M. Yassine Boubkari pour son encadrement au sein de
Saint-Gobain Sekurit Maroc. Ses remarques m'ont aidé à garder le projet proche
du terrain : une imprimante industrielle ne se résume pas à des courbes sur un
tableau de bord, elle fait partie d'une ligne de production réelle, avec ses
contraintes, ses arrêts, ses consommables et ses exigences de qualité.

Je remercie également Prof. T. Boujiha pour son encadrement académique, pour le
suivi du travail et pour les orientations données tout au long de ce projet.
Ses conseils m'ont permis de mieux structurer la démarche et de relier la partie
technique aux objectifs d'un projet de fin d'année.

Mes remerciements vont aussi aux équipes de Saint-Gobain Sekurit Maroc qui ont
partagé leur connaissance de la ligne, du marquage industriel et du contexte de
production. Ces échanges ont beaucoup compté, parce qu'ils donnent au projet une
réalité que les outils seuls ne peuvent pas apporter.

Je remercie les enseignants de l'École Nationale des Sciences Appliquées de
Kénitra pour la formation reçue en réseaux, systèmes de communication et
informatique industrielle. Enfin, je remercie ma famille et mes proches pour
leur soutien pendant la préparation de ce travail.
...
\begin{description}[style=nextline,leftmargin=3.4cm,labelwidth=3cm]
  ...
  \item[ACL] Access Control List, liste de droits d'accès.
  \item[LWT] Last Will and Testament, message MQTT publié lors d'une déconnexion anormale.
  \item[RPO] Recovery Point Objective, perte de données maximale admissible.
  \item[RTO] Recovery Time Objective, durée maximale de reprise visée.
...
\input{chapters/02-entreprise}
\input{chapters/03-etat-art}
\input{chapters/03-contexte-besoins}
\input{chapters/04-methodologie}
\input{chapters/04-conception}
\input{chapters/05-realisation}
\input{chapters/06-supervision}
\input{chapters/07-validation}
\input{chapters/08-securite}
\input{chapters/09-industrialisation}
\input{chapters/09-conclusion}
\appendix
\input{chapters/10-annexes}
...
\bibitem{nist80082}
National Institute of Standards and Technology, \emph{Guide to Operational
Technology (OT) Security}, NIST SP 800-82 Rev.~3, 2023,
\url{https://csrc.nist.gov/pubs/sp/800/82/r3/final}.

\bibitem{iec62443}
ISA, \emph{ISA/IEC 62443 Series of Standards -- Industrial Automation and
